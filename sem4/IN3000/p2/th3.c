...
int is_hit(double x, double y)
{
     ...
     */
    x2 = x * x;
    __asm__ volatile("pushal ; call yield ; popal");
    y2 = y * y;
...
void mcpi_thread0(void)
{
    ...
    scrprintf(MCPI_Y, 0, "Thread  4-7 (MCPi)    : ");
    scrprintf(MCPI_Y, MCPI_X0, "running");
  ...
  yield();
    ...
    res = (4.0 * ghit) / DARTS;
    scrprintf(MCPI_Y, MCPI_FINAL, "final");
...
void mcpi_thread1(void)
{
    ...
    scrprintf(MCPI_Y, MCPI_X1, "running");
...
void mcpi_thread2(void)
{
    ...
    scrprintf(MCPI_Y, MCPI_X2, "running");
...
void mcpi_thread3(void)
{
    ...
    scrprintf(MCPI_Y, MCPI_X3, "running");
